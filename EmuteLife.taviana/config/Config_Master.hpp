...
/* System Settings */
    ...
    gang_price = 0; //Gang creation price. --Remember they are persistent so keep it reasonable to avoid millions of gangs.
    ...
    paycheck_civ = 1000000; //Payment for civillians
